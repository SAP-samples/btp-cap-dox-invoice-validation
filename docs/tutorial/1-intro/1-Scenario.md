...
2. The invoice PDF file will be preprocessed by **SAP Document AI** Service.
...
5. The Accounting Team Member is doing a last double check and forwards the validated invoice to **SAP Ariba Central Invoice Management**.
